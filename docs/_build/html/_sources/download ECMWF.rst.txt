...
This will prepare and download the data in files that contain as much one month of data. For time periods longer than one month, separate files will be downloaded.
